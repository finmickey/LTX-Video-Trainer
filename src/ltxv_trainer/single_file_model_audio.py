...
class FromOriginalModelMixin:
    ...
    def from_single_file(
        cls, pretrained_model_link_or_path_or_dict: Optional[str] = None, **kwargs
    ) -> Self:
        r"""
        ...
        if original_config is not None:
            ...
            config_mapping_kwargs = _get_mapping_function_kwargs(
                config_mapping_fn, **kwargs
            )
            ...
            model_kwargs = {
                k: kwargs.get(k)
                for k in kwargs
                if k in expected_kwargs or k in optional_kwargs
            }
            diffusers_model_config.update(model_kwargs)

        checkpoint_mapping_kwargs = _get_mapping_function_kwargs(
            checkpoint_mapping_fn, **kwargs
        )
